    ...
    return (
      <div className={styles['user-edite']}>
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem label="请输入原密码" labelCol={{ span: 7 }} wrapperCol={{ span: 14 }}>
            {getFieldDecorator('old_passwd', {
              rules: [{ required: true, message: 'Please input your note!' }],
            })(<Input type="password" />)}
          </FormItem>
          <FormItem label="请输入新密码" labelCol={{ span: 7 }} wrapperCol={{ span: 14 }}>
            {getFieldDecorator('new_passwd', {
              rules: [{ required: true, message: '请输入新密码!' }],
            })(<Input type="password" />)}
          </FormItem>
          <FormItem label="请再次输入新密码" labelCol={{ span: 7 }} wrapperCol={{ span: 14 }}>
