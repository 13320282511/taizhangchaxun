      ...
      for (let i = 0; i < arrayData.length; i++) {
        for (let j = 0; j < ministryLevel.length; j++) {
          if (arrayData[i] == ministryLevel[j]) {
            arrayData[i] = `<span style='color:${this.state.leaderColor.ministryLevel}'>${
              arrayData[i]
            }</span>`;
          }
        }
        for (let j = 0; j < hallLevel.length; j++) {
          if (arrayData[i] == hallLevel[j]) {
            arrayData[i] = `<span style='color:${this.state.leaderColor.hallLevel}'>${
              arrayData[i]
            }</span>`;
          }
        }
        for (let j = 0; j < departmentLevel.length; j++) {
          if (arrayData[i] == departmentLevel[j]) {
            arrayData[i] = `<span style='color:${this.state.leaderColor.departmentLevel}'>${
              arrayData[i]
            }</span>`;
          }
        }
